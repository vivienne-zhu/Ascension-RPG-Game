...
public class GameCharacters {
	 ...
	 * initializes sound effects, potionMap, cp, hp, and adds cp and hp to
	 * potionMap.
	 */
	...
	/**
	 * This method is used by enemy healer exclusively to heal itself or rest of
	 * team
	 * 
	...
	/**
	 * This method allows the character to revive if the character has a revive. It
	 * replenishes both stamina and mana (depending on player type)
	 */
	public void revive() {
		if (isHasRevive() == true) {
	...
	/**
	 * This method increases the attack, defense, stamina, magic attack and mana of
	 * the hero when certain conditions are met. It also sets the level as it
	 * increases.
	 */
	public void levelUp() {
	 ...
	 * @param hurt   Boolean saying whether to display the image of the character
	 *               when hurt.
	 * @param heal   Boolean saying whether to display the image of the character
	 *               when they heal.
	 */
