...
/**
 * This class is an extension of the GameCharacters class. It represents a Rogue
 * game character.
 * 
...
public class Rogue extends GameCharacters {
	/**
	 * The constructor sets the stats(attack, defense and stamina etc.) and type of
	 * the Rogue object, and also sets the values needed to display the image
	 * instance variables in the GUI.
	 */
	public Rogue() {
		setAttack(170);
		setDefense(45);
