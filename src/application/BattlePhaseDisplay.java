...
public class BattlePhaseDisplay {
	...
	/**
	 * This method reset the width of the bar based on game characters' stats in the
	...
	public VBox heroStatsDisplay(GameCharacters hero) {
		...
		Text stats = new Text("Level: " + hero.getLevel() + "\t\tExp: " + hero.getXp() + " / " + levelXp + "\nGold: "
				+ hero.getGold() + "\t\tAttack: " + hero.getAttack() + "\nDefense: " + hero.getDefense());
	...
	/**
	 * This method will display relevant combat information like player/enemy names
	 * and health
	 * 
	...
	public void dispCombatInfo(GameCharacters hero, HashMap<Integer, ArrayList<GameCharacters>> allEnemies, int floor) {
		...
		enemyStam = new Text("Stamina: " + allEnemies.get(floor).get(0).getCurrentStamina() + " / "
				+ allEnemies.get(floor).get(0).getStamina());
		...
		if (allEnemies.get(floor).size() > 1) {
			...
			enemyTwoStam = new Text("Stamina: " + allEnemies.get(floor).get(1).getCurrentStamina() + " / "
					+ allEnemies.get(floor).get(1).getStamina());
		...
		if (allEnemies.get(floor).size() > 2) {
			...
			enemyThreeStam = new Text("Stamina: " + allEnemies.get(floor).get(2).getCurrentStamina() + " / "
					+ allEnemies.get(floor).get(2).getStamina());
			enemyThreeStam.setId("battlePhase");
		}
	}

	/**
	 * This method will properly create and format the three dialogue boxes used for
	 * combat information
	 */
	...
	/**
	 * This method properly formats the GridPane layout used to display most
	 * information like character name, character health, the three dialogue boxes,
	 * and various buttons
	 * 
