...
class ShopTest {
	...
	/**
	 * This tests the buy potion method when no quantity or 0 is provided as an
	 * input.
	 * 
	 */
	@Test
	...
	/**
	 * This tests the buy potion method when the player has enough gold to buy the
	 * potion.
	 * 
	 */
	@Test
	...
	/**
	 * This tests the buy potion method when the player does not have enough gold to
	 * buy the potion.
	 * 
	 */
	@Test
	...
	/**
	 * This tests the buy potion method when invalid input is provided as an
	 * quantity.
	 * 
	 */
	@Test
	...
	void testEmptyTextSellPotion() {
		...
		q.setText("");
		shop.sellPotion(hero.getCp(), q, errorMsg, display);
		assertEquals("INVALID QUANTITY", q.getText());
	...
	/**
	 * This tests the sell potion method when the player has the quantity of items
	 * to sell.
	 * 
	 */
	@Test
	void testHasItemSellPotion() {
		...
		hero.setGold(0);
		q.setText("2");
		hero.getPotionMap().put(hero.getCp(), 2);

		shop.sellPotion(hero.getCp(), q, errorMsg, display);

		assertEquals(50, hero.getGold());
		assertEquals(0, hero.getPotionMap().get(hero.getCp()));

	}

	/**
	 * This tests the sell potion method when the player does not have enough items
	 * to sell.
	 * 
	 */
	@Test
	void testNoItemSellPotion() {
		...
		q.setText("2");
		hero.getPotionMap().put(hero.getCp(), 0);
	...
	/**
	 * This tests the sell potion method when invalid input is provided by the
	 * player as quantity.
	 * 
	 */
	@Test
	void testInvalidSellPotion() {
		...
		assertEquals("NUMBERS ONLY", q.getText());
	}

	/**
	 * This tests the buyRevive method when the player has no revive and enough
	 * gold.
	 * 
	 */
	@Test
