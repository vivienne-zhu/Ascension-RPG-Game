...
/**
 * This class represents and controls event that can happen randomly in the
 * game.
 * 
 * @author JiayuZhu
 *
...
public class Event {
	...
	/**
	 * This method determines whether the special event occurs. The chance of the
	 * occurrence of a special event is 20%.
	 */
	...
	public void jumpFloor(GameCharacters hero, Floor floor, Text display) {
		...
		display.setText(
				"A map that shows a secret path to avoid the enemies..." + "You get to floor " + newFloor + "!");
	}

	/**
	 * This method will trigger the drop floor event. The player will move down to
	 * the lower floor.
	 * 
	 * @param floor   The current floor the player is on
	...
	/**
	 * This method will trigger the get gold event. The player will receive a random
	 * amount of gold from 1-200.
	 * 
	 * @param hero The player hero
	...
	/**
	 * This method will trigger the lost gold event. The player will lose a random
	 * amount of gold from 0-100.
	 * 
	 * @param hero    The player hero
	...
	public void loseGold(GameCharacters hero, Floor floor, Text display) {
		...
		display.setText(
				"A Goblin appears and takes " + lostGold + " gold away...You now have " + hero.getGold() + " gold.");
	 ...
	 */
	public void openChest(GameCharacters hero, Floor floor, Button continueBtn, GridPane grid, ImageView closedIV,
			ImageView openIV, Button openBtn, Text display) {
